<template>
  <q-layout view="lHh Lpr lFf" class="user-app">
    <q-page-container><q-page class="user-app__page"><div class="user-app__shell">
      ...
      <main v-if="activeMenu === 'home'" class="user-app__main"><span class="user-app__eyebrow">AitoLearn / Area do usuario</span><h1>Aprenda a criar software que o mercado valoriza.</h1><p>Seu acesso a aulas, materiais e suporte fica reunido aqui.</p><div class="user-app__grid"><section><q-icon name="mdi-school-outline" size="30px" /><strong>Curso Fullstack Developer</strong><span>Frontend, backend, pagamentos, cloud, IA e 3D.</span><q-btn unelevated no-caps label="Conhecer lancamento" icon="mdi-arrow-top-right" @click="router.push('/aitolearn')" /></section><section><q-icon name="mdi-progress-check" size="30px" /><strong>Seu progresso</strong><span>A trilha de fundamentos sera liberada em breve.</span></section><section><q-icon name="mdi-lifebuoy" size="30px" /><strong>Suporte</strong><span>Abra um chamado quando precisar da equipe.</span></section></div></main>
